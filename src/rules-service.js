(function (scope) {
    ...
    function Rule(name, options) {
        ...
        if (typeof options.resolvePath === 'function') { Reflect.defineProperty(this, 'resolvePath', { value: options.resolvePath }); }
    }
    Rule.prototype.resolvePath = function () {
    ...
    function addRule(rule) {
        ...
        if (!rule || !(rule instanceof Rule)) {
            throw new Error('rule MUST be an object of type "Rule" (example: "new RulesService.Rule();")');
        }
    ...
    function RulesService(internalAPIs) {
        apis = internalAPIs;
