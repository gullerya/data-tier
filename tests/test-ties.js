...
suite.addTest({name: 'adding a tie and then a view'}, (pass, fail) => {
...
suite.addTest({name: 'adding a view and then a tie'}, (pass, fail) => {
	let newEl = document.createElement('div'),
		text = 'text test B';
...
suite.addTest({name: 'creating a tie with an undefined data'}, (pass, fail) => {
	let newEl = document.createElement('div'),
		o = {text: 'text test C'},
...
suite.addTest({name: 'creating a tie with a NULL data'}, (pass, fail) => {
	let newEl = document.createElement('div'),
		o = {text: 'text test D'},
...
suite.addTest({name: 'setting a tie with a non Observable object'}, (pass, fail) => {
	let newEl = document.createElement('div'),
		o = {text: 'text test E'},
...
suite.addTest({name: 'setting a tie with a non object value - negative'}, (pass, fail) => {
	try {
...
suite.addTest({name: 'tie should be sealed - negative'}, (pass, fail) => {
	try {
